                    ...
                    <div class="col-lg-6">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <form id="userForm" name="userForm" action="<?php echo Route::to('monitor.adduser') ?>" role="form" method="post" class="form-horizontal">
                                    <fieldset>
                                            ...
                                            <div class="col-md-9">
                                                <select name="department" id="department">
                                                    <?php foreach ($departments as $department): ?>
                                                        <option value="<?php echo $department['c_mc'] ?>"><?php echo $department['c_mc'] ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-9 col-md-offset-3">
                                                <button type="submit" class="btn btn-lg btn-success btn-block">新增</button>
                                            </div>
                                        </div>
                                    </fieldset>
                                </form>
